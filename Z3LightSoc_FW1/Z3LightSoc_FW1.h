...
#define EM_AF_GENERATED_NETWORK_STRINGS  \
  "Primary (pro)", \
/**** ZCL Section ****/
#define ZA_PROMPT "Z3LightSoc_FW1"
...
#define EMBER_AF_PLUGIN_OTA_CLIENT_POLICY_FIRMWARE_VERSION 0
...
#define EMBER_AF_API_EEPROM "../../v4/developer/sdks/gecko_sdk_suite/v2.7/util/plugin/plugin-common/eeprom/eeprom.h"
