...
class IPhy(object):
    ...
    """
    @abstractmethod
    def _makePhy(self, modem_model, profile, phy_description=None, phy_group_name=None, readable_name=None, act_logic='', tags='', phy_name=None):
        ...
        if existing_phy == None:
            ...
            if '_prod' in phy_name.lower():
                ...
                phy_points_to = None
            phy = ModelPhy(phy_name, phy_description, profile, phy_group_name, readable_name=readable_name, act_logic=act_logic, tags=tags, phy_points_to = phy_points_to)
