...
#
# Generated Thu Jan  2 13:45:37 2020 by generateDS.py version 2.12d.
#
...
class phyType(supermod.phyType):
    def __init__(self, name=None, readable_name=None, desc=None, group_name=None, profile_name=None, act_logic=None, tags=None, profile_inputs=None, profile_outputs=None):
        super(phyType, self).__init__(name, readable_name, desc, group_name, profile_name, act_logic, tags, profile_inputs, profile_outputs, )
