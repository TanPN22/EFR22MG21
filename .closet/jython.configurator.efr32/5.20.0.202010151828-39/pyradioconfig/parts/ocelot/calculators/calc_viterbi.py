...
class CALC_Viterbi_ocelot(CALC_Viterbi_lynx):
    ...
    def calc_shift_trecs_pre_bits_to_syncword(self, model):
        ...
        if demod_select == model.vars.demod_select.var_enum.TRECS_VITERBI or \
            ...
            if syncword_len < target_cfe_len:
                ...
                #The syncword is already long enough to meet our target CFE length
                trecs_pre_bits_to_syncword = 0
    ...
    def calc_pmoffset_reg(self, model):
        ...
        self._reg_write(model.vars.MODEM_TRECSCFG_PMOFFSET,  osr * pmwinsize + 2)
    ...
    def calc_viterbi_misc_reg(self, model):
        ...
        if vtdemoden:
            ...
            self._reg_write(model.vars.MODEM_REALTIMCFE_VTAFCFRAME, 1)
            ...
            self._reg_write(model.vars.MODEM_REALTIMCFE_TRACKINGWIN, 0)
