...
class PHYS_OQPSK_LoRa_Ocelot(IPhy):
    ...
    # Owner: Young-Joon Choi
    # Jira Link: Jira Link: https://jira.silabs.com/browse/PGOCELOTVALTEST-185
    ...
    # Owner: Young-Joon Choi
    # Jira Link: Jira Link: https://jira.silabs.com/browse/PGOCELOTVALTEST-186
    ...
    # Owner: Young-Joon Choi
    # Jira Link: Jira Link: https://jira.silabs.com/browse/PGOCELOTVALTEST-187
    ...
    # Owner: Young-Joon Choi
    # Jira Link: Jira Link: https://jira.silabs.com/browse/PGOCELOTVALTEST-188
