...
class PHYS_IEEE802154_WiSUN_Ocelot(IPhy):
    ...
    def PHY_IEEE802154_WISUN_868MHz_2GFSK_50kbps_1a_EU(self, model, phy_name=None):
        ...
        phy.profile_inputs.preamble_length.value = 8 * 8  # FAN EU Mode #1a, WiSUN 20140727-PHY-Profile Table 6calc_timthresh_actual
        phy.profile_inputs.syncword_0.value = self.phySunFskSfd_0_uncoded
