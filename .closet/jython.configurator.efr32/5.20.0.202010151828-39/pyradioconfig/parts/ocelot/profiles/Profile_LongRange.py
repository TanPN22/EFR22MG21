...
class Profile_Long_Range_Ocelot(Profile_Long_Range_Nixi):
    ...
    def build_advanced_profile_inputs(self, model, profile):
        IProfile.make_linked_io(profile, model.vars.rx_xtal_error_ppm, 'crystal', readable_name="RX Crystal Accuracy in ppm", value_limit_min=0, value_limit_max=200)
        IProfile.make_linked_io(profile, model.vars.tx_xtal_error_ppm, 'crystal', readable_name="TX Crystal Accuracy in ppm", value_limit_min=0, value_limit_max=200)
    ...
    def _fixed_longrange_vars(self, model):
        ...
        """ XO Parameters """
        model.vars.xtal_frequency_hz.value_forced = 39000000
