...
class Pro2OcelotModemCalcInputs(Pro2PlusModemCalcInputs):
    ...
    def _init_from_input_array(self, input_array):
        super(Pro2OcelotModemCalcInputs,self)._init_from_input_array(input_array[:-3])
        self.API_dsm_ratio = input_array[-3]
        self.API_Fs_rx_CH = input_array[-2]
        self.API_fb_frequency_resolution = input_array[-1]
