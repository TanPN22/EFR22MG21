...
if [ -z "${PATH_SCMD}" ]; then
  COMMANDER="D:\DH\Lumi\Zigbee\SimplicityStudio\SimplicityStudio\v4\developer\adapter_packs\commander\commander.exe"
...
echo " "
"${COMMANDER}" convert "D:\DH\Lumi\Zigbee\SimplicityStudio\SimplicityStudio\v4\developer\sdks\gecko_sdk_suite\v2.7/platform/bootloader/build/first_stage/iar/first_stage_btl_efx32xg13.s37" "${FILENAME}-crc.s37" -o "${FILENAME}-combined.s37"
